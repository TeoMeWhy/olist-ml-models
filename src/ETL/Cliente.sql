...
--tabela para descobrir para onde os vendedores vendem
WITH tb_join AS (
...
tb_group AS (
--pivotar a tabela para saber o percentual de pedidos por estado por vendedor
  SELECT
    idVendedor,
...
SELECT 
    '2018-01-01' AS dtReference, --data da foto do 
    *
